...
export default function AssinaturaCard() {
    ...
    const handleSubscribe = async () => {
        ...
        try {
            ...
            toast.error("Ocorreu um erro ao iniciar o processo de pagamento. Por favor, tente novamente.");
        }
        finally {
            setIsLoading(false);
        }
    };
    return (<div className="flex h-full flex-col rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
      ...
      <div className="mt-auto">
        ...
        {session ? (<button onClick={handleSubscribe} disabled={isLoading} className="w-full rounded bg-blue-600 px-4 py-2 text-white transition duration-300 hover:bg-blue-700 disabled:bg-blue-400">
