...
const BookingItem = ({ booking }) => {
    ...
    const { service: { barbershop }, barber, } = booking;
      ...
      <SheetContent className="flex w-[85%] flex-col">
        ...
        <div ref={contentRef} className="flex-1 overflow-y-auto">
          <div className="relative mt-6 flex h-[180px] w-full items-end">
            <Image alt={`Mapa da barbearia ${booking.service.barbershop.name}`} src="/map.png" fill className="rounded-xl object-cover"/>
            <Button className="absolute right-2 top-2 z-10" onClick={handleDirectionsClick}>
              Como chegar
            </Button>
          ...
          <div className="mt-6">
            ...
            <div className="mb-3 mt-6">
              <BookingSummary barbershop={barbershop} service={booking.service} selectedDate={booking.date} selectedBarberId={booking.barberId}/>
            </div>

            {barber && (<div className="mt-4">
