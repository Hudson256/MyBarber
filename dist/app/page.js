    ...
    return (<div>
      ...
      <div className="p-5">
        ...
        <div className="mt-6 flex gap-3 overflow-x-scroll [&::-webkit-scrollbar]:hidden">
          {quickSearchOptions.map((option) => (<Button className="gap-2" variant="secondary" key={option.title} asChild>
        ...
        <div className="relative mt-6 h-[150px] w-full md:h-[300px] lg:h-[300px]">
          <Image alt="Agende nos melhores com FSW Barber" src="/banner-01.png" fill className="rounded-xl object-cover md:object-fill lg:object-fill"/>
        </div>
