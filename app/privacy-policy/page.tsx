...
export const metadata: Metadata = {
  title: "Política de Privacidade | FSW Barber",
  description: "Política de Privacidade da FSW Barber",
}
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="space-y-4">
        <p>
          A sua privacidade é importante para nós. É política da FSW Barber
          respeitar a sua privacidade em relação a qualquer informação sua que
          possamos coletar no site FSW Barber, e outros sites que possuímos e
          operamos.
        </p>
        <p>
